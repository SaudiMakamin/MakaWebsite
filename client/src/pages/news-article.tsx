...
export default function NewsArticle() {
  ...
  const articleData: Record<string, any> = {
    'general-assembly-success-september-2025': {
      ...
      content: {
        lead: 'عقدت شركة مكامن جمعيتها العمومية غير العادية اليوم بنجاح، بحضور كبار المساهمين، من ضمنهم: شركة الدرة للخدمات البترولية، شركة بيت الطاقة، شركة بن طامي، وشركة عجلان العجلان، إضافة إلى عدد من المساهمين.\n\nالجمعية التي انطلقت عند الساعة 12 ظهرًا واستمرت حتى 4:30 عصرًا، شهدت حضورًا مميزًا من داخل المملكة وخارجها، من أبرزهم الدكتور المهندس خالد السيف من دولة الكويت الشقيقة.\n\nتم التصويت على البند الأول فقط نظرًا لأهميته القصوى، فيما تقرر تأجيل بقية البنود لمرحلة لاحقة بعد إجراء المواءمة المطلوبة.\n\nأُجري فرز الأصوات يدويًا، وجرى منع من لا يملك صلاحية التصويت – رغم حضوره بموجب وكالة – تنفيذًا صارمًا للأنظمة والتعليمات، مما يعكس التزام الشركة بالشفافية وحوكمة الإجراءات.\n\nونلتمس العذر لمن لم يتمكن من الحضور سواء عبر الرابط الإلكتروني\n\nhttps://teams.live.com/meet/9374841782235?p=9VuZpxCI45KVUjE9La\n\nأو شخصيًا، ونُقدر حرص الجميع على المشاركة في تحقيق أهداف الإصلاح وتطوير الشركة.\n\nونشكر امين السر والسكرتاريه والمراقبين على تحملهم الوقت الطويل وصبرهم الذي يشكرون عليه ونشكر خاص لشركه عجلان العجلان وشركه بن طامي والشركات الكبرى والمساهمين والمنهندسين والاساتذه الحضور على مقترحاتهم',
