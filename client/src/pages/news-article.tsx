...
export default function NewsArticle() {
  ...
  const articleData: Record<string, any> = {
    'extraordinary-general-assembly-rescheduled-2025': {
      category: 'corporate',
      categoryIcon: Building2,
      title: 'إعادة تحديد موعد الجمعية العمومية غير العادية - 30 سبتمبر 2025',
      ...
      tags: ['حوكمة مؤسسية', 'جمعية عمومية', 'مجلس إدارة', 'مساهمين', 'إعادة جدولة'],
      tagsAr: ['حوكمة مؤسسية', 'جمعية عمومية', 'مجلس إدارة', 'مساهمين', 'إعادة جدولة'],
      galleryImages: [
        {
          src: '/attached_assets/لقطة الشاشة 2025-07-21 172931_1754473884923.jpg',
          alt: 'مقر اجتماع الشركة بالرياض - مجمع الكناري',
          altAr: 'مقر اجتماع الشركة بالرياض - مجمع الكناري'
        }
      ],
      content: {
        lead: 'شركة مكامن السعودية القابضة لخدمات النفط والغاز (شركة مساهمة مقفلة)\nالسجل التجاري رقم: 1010251168\nإلى السادة المساهمين الكرام\n\nبناءً على أحكام نظام الشركات الصادر بالمرسوم الملكي رقم (م/132) وتاريخ 01/12/1443هـ، واللائحة التنفيذية لنظام الشركات وظروف الشركة القانونية، فقد قرر مجلس الإدارة إعادة تحديد موعد الجمعية العمومية غير العادية.',
        leadAr: 'شركة مكامن السعودية القابضة لخدمات النفط والغاز (شركة مساهمة مقفلة)\nالسجل التجاري رقم: 1010251168\nإلى السادة المساهمين الكرام\n\nبناءً على أحكام نظام الشركات الصادر بالمرسوم الملكي رقم (م/132) وتاريخ 01/12/1443هـ، واللائحة التنفيذية لنظام الشركات وظروف الشركة القانونية، فقد قرر مجلس الإدارة إعادة تحديد موعد الجمعية العمومية غير العادية.',
        
        body: [
          {
            title: 'الموعد الجديد للاجتماع',
            titleAr: 'الموعد الجديد للاجتماع',
            content: 'يُدعى السادة المساهمون لحضور اجتماع الجمعية العمومية غير العادية للشركة، والذي سيعقد – بمشيئة الله – يوم الثلاثاء الموافق 30/09/2025م، الساعة 12:00 ظهرًا، بمقر اجتماع الشركة في مدينة الرياض – حي السليمانية – مجمع الكناري.',
            contentAr: 'يُدعى السادة المساهمون لحضور اجتماع الجمعية العمومية غير العادية للشركة، والذي سيعقد – بمشيئة الله – يوم الثلاثاء الموافق 30/09/2025م، الساعة 12:00 ظهرًا، بمقر اجتماع الشركة في مدينة الرياض – حي السليمانية – مجمع الكناري.'
          },
          {
            title: 'البند الأول: تعديل النظام الأساسي',
            titleAr: 'البند الأول: تعديل النظام الأساسي',
            content: 'الموافقة على تعديل النظام الأساسي للشركة وموائمته مع أحكام نظام الشركات الصادر بالمرسوم الملكي رقم (م/132) وتاريخ 01/12/1443هـ، ولائحته التنفيذية وتفويض مجلس الإدارة أو من يفوضه في استكمال وتوقيع كافة الإجراءات النظامية اللازمة لدى وزارة التجارة والجهات المختصة.',
            contentAr: 'الموافقة على تعديل النظام الأساسي للشركة وموائمته مع أحكام نظام الشركات الصادر بالمرسوم الملكي رقم (م/132) وتاريخ 01/12/1443هـ، ولائحته التنفيذية وتفويض مجلس الإدارة أو من يفوضه في استكمال وتوقيع كافة الإجراءات النظامية اللازمة لدى وزارة التجارة والجهات المختصة.'
          },
          {
            title: 'البند الثاني: إحاطة بالوقائع السابقة',
            titleAr: 'البند الثاني: إحاطة بالوقائع السابقة',
            content: 'إحاطة الجمعية العمومية بالوقائع التي تمت خلال الفترة من (2019م – 18/02/2025م) وأهمها بيع المقر الرئيسي وتصفية شركة مكامن البترولية والأوفشور، وما ترتب عليها من مخالفات نظامية تسببت في فقدان أصول للشركة دون تفويض نظامي صحيح أو علم المساهمين، واعتماد تثبيت هذه الإحاطة في محضر الاجتماع كأساس نظامي لأي مطالبات أو إجراءات قانونية لاحقة.',
            contentAr: 'إحاطة الجمعية العمومية بالوقائع التي تمت خلال الفترة من (2019م – 18/02/2025م) وأهمها بيع المقر الرئيسي وتصفية شركة مكامن البترولية والأوفشور، وما ترتب عليها من مخالفات نظامية تسببت في فقدان أصول للشركة دون تفويض نظامي صحيح أو علم المساهمين، واعتماد تثبيت هذه الإحاطة في محضر الاجتماع كأساس نظامي لأي مطالبات أو إجراءات قانونية لاحقة.'
          },
          {
            title: 'البند الثالث: التقرير السري والجنائي',
            titleAr: 'البند الثالث: التقرير السري والجنائي',
            content: 'استعراض التقرير السري والجنائي وما أسفر عنه من نتائج تتعلق بأعمال المجالس السابقة، وما تضمنه من مخالفات نظامية، واعتماد ما يلزم بشأنها.',
            contentAr: 'استعراض التقرير السري والجنائي وما أسفر عنه من نتائج تتعلق بأعمال المجالس السابقة، وما تضمنه من مخالفات نظامية، واعتماد ما يلزم بشأنها.'
          },
          {
            title: 'البند الرابع: خارطة الطريق الشاملة',
            titleAr: 'البند الرابع: خارطة الطريق الشاملة',
            content: 'المناقشة والموافقة على خارطة الطريق الشاملة لإعادة تشغيل الفروع والشركة القابضة، والمقدمة من مجلس الإدارة الحالي (فريق الإصلاح).',
            contentAr: 'المناقشة والموافقة على خارطة الطريق الشاملة لإعادة تشغيل الفروع والشركة القابضة، والمقدمة من مجلس الإدارة الحالي (فريق الإصلاح).'
          },
          {
            title: 'البند الخامس: تخصيص الأسهم لفريق الإصلاح',
            titleAr: 'البند الخامس: تخصيص الأسهم لفريق الإصلاح',
            content: 'النظر في مقترح تخصيص نسبة من أسهم المساهمين الراغبين لصالح فريق الإصلاح على أساس طوعي واختياري، مع التأكيد على استبعاد الرئيس التنفيذي ورئيس المجلس من أي تخصيص لتجنب تعارض المصالح، وذلك وفقًا للضوابط النظامية.',
            contentAr: 'النظر في مقترح تخصيص نسبة من أسهم المساهمين الراغبين لصالح فريق الإصلاح على أساس طوعي واختياري، مع التأكيد على استبعاد الرئيس التنفيذي ورئيس المجلس من أي تخصيص لتجنب تعارض المصالح، وذلك وفقًا للضوابط النظامية.'
          },
          {
            title: 'البند السادس: تحديث ملكيات الأسهم',
            titleAr: 'البند السادس: تحديث ملكيات الأسهم',
            content: 'الموافقة على تحديث وتسجيل ملكيات الأسهم وتوثيقها رسميًا لدى وزارة التجارة، وتحديد موعد نهائي للمساهمين لاستيفاء المتطلبات وسداد القيمة غير المسددة من أسهمهم، وفي حال التخلف يتخذ مجلس الإدارة الإجراءات النظامية، بما في ذلك الإنذار والتصرف في الأسهم وفقًا لما تقرره الأنظمة واللوائح.',
            contentAr: 'الموافقة على تحديث وتسجيل ملكيات الأسهم وتوثيقها رسميًا لدى وزارة التجارة، وتحديد موعد نهائي للمساهمين لاستيفاء المتطلبات وسداد القيمة غير المسددة من أسهمهم، وفي حال التخلف يتخذ مجلس الإدارة الإجراءات النظامية، بما في ذلك الإنذار والتصرف في الأسهم وفقًا لما تقرره الأنظمة واللوائح.'
          },
          {
            title: 'البند السابع: مكافأة الرئيس التنفيذي',
            titleAr: 'البند السابع: مكافأة الرئيس التنفيذي',
            content: 'اعتماد صرف مكافأة مالية شهرية للرئيس التنفيذي اعتبارًا من تاريخ تفويض المساهمين له بمباشرة العمل، على أن تكون خاضعة لنتائج الأداء الجوهرية وتوصية أعضاء المجلس واعتماد الجمعية العمومية، التزامًا بضوابط النظام.',
            contentAr: 'اعتماد صرف مكافأة مالية شهرية للرئيس التنفيذي اعتبارًا من تاريخ تفويض المساهمين له بمباشرة العمل، على أن تكون خاضعة لنتائج الأداء الجوهرية وتوصية أعضاء المجلس واعتماد الجمعية العمومية، التزامًا بضوابط النظام.'
          },
          {
            title: 'البند الثامن: صلاحيات تعديل جدول الأعمال',
            titleAr: 'البند الثامن: صلاحيات تعديل جدول الأعمال',
            content: 'إقرار صلاحية مجلس الإدارة في تعديل جدول الأعمال بإضافة أو إلغاء أو تعديل أي بند قبل موعد انعقاد الجمعية بعشرة أيام على الأقل إذا اقتضت مصلحة الشركة أو مساهميها ذلك، على أن يتم إشعار المساهمين بالبنود المضافة وفقًا للإجراءات النظامية.',
            contentAr: 'إقرار صلاحية مجلس الإدارة في تعديل جدول الأعمال بإضافة أو إلغاء أو تعديل أي بند قبل موعد انعقاد الجمعية بعشرة أيام على الأقل إذا اقتضت مصلحة الشركة أو مساهميها ذلك، على أن يتم إشعار المساهمين بالبنود المضافة وفقًا للإجراءات النظامية.'
          },
          {
            title: 'تنويه هام - النصاب',
            titleAr: 'تنويه هام - النصاب',
            content: 'في حال عدم اكتمال النصاب النظامي للاجتماع الأول، سيعقد الاجتماع الثاني بعد ساعة من الموعد المحدد للاجتماع الأول في نفس اليوم والمكان، ويكون الاجتماع الثاني صحيحًا إذا حضره مساهمون يمثلون ربع رأس المال على الأقل. وفي حال عدم اكتمال النصاب في الاجتماع الثاني، سيتم عقد اجتماع ثالث، ويكون صحيحًا أيًا كان عدد الأسهم الممثلة فيه بعد موافقة الجهة المختصة.',
            contentAr: 'في حال عدم اكتمال النصاب النظامي للاجتماع الأول، سيعقد الاجتماع الثاني بعد ساعة من الموعد المحدد للاجتماع الأول في نفس اليوم والمكان، ويكون الاجتماع الثاني صحيحًا إذا حضره مساهمون يمثلون ربع رأس المال على الأقل. وفي حال عدم اكتمال النصاب في الاجتماع الثاني، سيتم عقد اجتماع ثالث، ويكون صحيحًا أيًا كان عدد الأسهم الممثلة فيه بعد موافقة الجهة المختصة.'
          },
          {
            title: 'ملاحظات هامة',
            titleAr: 'ملاحظات هامة',
            content: 'سيتم إتاحة وسائل التقنية الحديثة لتمكين المساهمين من المشاركة والتصويت عن بُعد وفقًا للضوابط المعتمدة من الجهات المختصة. للشركات الكبرى الدولية وللمساهمين قبل موعد الجمعية بنصف ساعة.',
            contentAr: 'سيتم إتاحة وسائل التقنية الحديثة لتمكين المساهمين من المشاركة والتصويت عن بُعد وفقًا للضوابط المعتمدة من الجهات المختصة. للشركات الكبرى الدولية وللمساهمين قبل موعد الجمعية بنصف ساعة.'
          },
          {
            title: 'ملاحظة للمساهمين',
            titleAr: 'ملاحظة للمساهمين',
            content: 'تصويتك في هذه الجمعية سيُعيد تشكيل الشركة من الأساس.\nلا تفوّت هذه اللحظة التاريخية.\n\nنحن نُعيد "مكامن" إلى مسارها السيادي — بصوتك أنت.\nكن في الموعد — كن من صانعي القرار.\n\nللاستفسارات: media@makamin.com.sa',
    ...
    'extraordinary-general-assembly-2025': {
      ...
      content: {
        lead: 'شركة مكامن السعودية القابضة لخدمات النفط والغاز (شركة مساهمة مقفلة)\nالسجل التجاري رقم: 1010251168\nإلى السادة المساهمين الكرام\n\nيسر مجلس إدارة شركة مكامن السعودية القابضة لخدمات النفط والغاز أن يدعوكم لحضور اجتماع الجمعية العمومية غير العادية، والذي سيعقد – بمشيئة الله – في تمام الساعة 12:00 ظهرًا من يوم السبت الموافق 23/08/2025م، وذلك في مقر اجتماع الشركة بمدينة الرياض – حي السليمانية – مجمع كناري، وذلك للنظر في جدول الأعمال المرفق.',
        leadAr: 'شركة مكامن السعودية القابضة لخدمات النفط والغاز (شركة مساهمة مقفلة)\nالسجل التجاري رقم: 1010251168\nإلى السادة المساهمين الكرام\n\nيسر مجلس إدارة شركة مكامن السعودية القابضة لخدمات النفط والغاز أن يدعوكم لحضور اجتماع الجمعية العمومية غير العادية، والذي سيعقد – بمشيئة الله – في تمام الساعة 12:00 ظهرًا من يوم السبت الموافق 23/08/2025م، وذلك في مقر اجتماع الشركة بمدينة الرياض – حي السليمانية – مجمع كناري، وذلك للنظر في جدول الأعمال المرفق.',
        ...
        body: [
          {
            title: 'البند (1)',
            titleAr: 'البند (1)',
            content: 'الموافقة على تعديل النظام الأساسي ومواءمته مع نظام الشركات الجديد',
            contentAr: 'الموافقة على تعديل النظام الأساسي ومواءمته مع نظام الشركات الجديد'
          },
          {
            title: 'البند (2)',
            titleAr: 'البند (2)',
            content: 'الموافقة على خارطة الطريق الشاملة لإعادة تأسيس الشركة – المقدمة من فريق الإصلاح',
            contentAr: 'الموافقة على خارطة الطريق الشاملة لإعادة تأسيس الشركة – المقدمة من فريق الإصلاح'
          },
          {
            title: 'البند (3)',
            titleAr: 'البند (3)',
            content: 'إحاطة وتاريخ العلم – وقائع بيع المقر وتصفية الفروع\n\nيحيط مجلس الإدارة الجمعية العمومية غير العادية علمًا بما يلي:\nأنه وفقًا لما ورد في السجلات الرسمية والتقارير السرية، فقد تم في الفترات السابقة (2019–2022م) إبرام تصرفات جوهرية تتعلق ببيع مقر الشركة وتصفية فرع شركة مكامن البترولية وفرع الأوفشور، وما ترتب على ذلك من فقدان معدات وبواخر وسيارات وكوادر فنية وإدارية، وذلك دون وجود تفويض صريح أو موافقة من الجمعية العمومية.\n\nويُعتبر هذا الإشعار المقدم في جدول الاعمال واجتماع الجمعية العمومية غير العادية تاريخ العلم الرسمي لكل من:\n• مجلس الإدارة الحالي.\n• جميع المساهمين الحاضرين أو الممثلين.\n• الجهات الرقابية المختصة (وزارة التجارة، الجهات القضائية والرقابية ذات الصلة).\n\nويُثبت هذا البيان في محضر الاجتماع كأساس نظامي لأي مطالبات أو دعاوى قضائية أو إجراءات رقابية لاحقة قرار اللجنة للمخالفة المرفقة',
            contentAr: 'إحاطة وتاريخ العلم – وقائع بيع المقر وتصفية الفروع\n\nيحيط مجلس الإدارة الجمعية العمومية غير العادية علمًا بما يلي:\nأنه وفقًا لما ورد في السجلات الرسمية والتقارير السرية، فقد تم في الفترات السابقة (2019–2022م) إبرام تصرفات جوهرية تتعلق ببيع مقر الشركة وتصفية فرع شركة مكامن البترولية وفرع الأوفشور، وما ترتب على ذلك من فقدان معدات وبواخر وسيارات وكوادر فنية وإدارية، وذلك دون وجود تفويض صريح أو موافقة من الجمعية العمومية.\n\nويُعتبر هذا الإشعار المقدم في جدول الاعمال واجتماع الجمعية العمومية غير العادية تاريخ العلم الرسمي لكل من:\n• مجلس الإدارة الحالي.\n• جميع المساهمين الحاضرين أو الممثلين.\n• الجهات الرقابية المختصة (وزارة التجارة، الجهات القضائية والرقابية ذات الصلة).\n\nويُثبت هذا البيان في محضر الاجتماع كأساس نظامي لأي مطالبات أو دعاوى قضائية أو إجراءات رقابية لاحقة قرار اللجنة للمخالفة المرفقة'
          },
          {
            title: 'البند (4)',
            titleAr: 'البند (4)',
            content: 'المساءلة النظامية للمجالس السابقة – عرض مخالفات المجلس السابق وقرار لجنة المخالفات',
            contentAr: 'المساءلة النظامية للمجالس السابقة – عرض مخالفات المجلس السابق وقرار لجنة المخالفات'
          },
          {
            title: 'البند (5)',
            titleAr: 'البند (5)',
            content: 'الموافقة على برنامج تحفيز فريق الإصلاح – لتمويل أعمال الاسترداد القانونية والفنية',
            contentAr: 'الموافقة على برنامج تحفيز فريق الإصلاح – لتمويل أعمال الاسترداد القانونية والفنية'
          },
          {
            title: 'البند (6)',
            titleAr: 'البند (6)',
            content: 'الموافقة على تعيين الدكتور إبراهيم الجلال رئيسًا للجنة المراجعة',
            contentAr: 'الموافقة على تعيين الدكتور إبراهيم الجلال رئيسًا للجنة المراجعة'
          },
          {
            title: 'البند (7)',
            titleAr: 'البند (7)',
            content: 'خيار تخصيص نسبة من أسهم المساهمين الراغبين لصالح مجلس الإصلاح – تطوعي واختياري',
            contentAr: 'خيار تخصيص نسبة من أسهم المساهمين الراغبين لصالح مجلس الإصلاح – تطوعي واختياري'
          },
          {
            title: 'البند (8)',
            titleAr: 'البند (8)',
            content: 'يجوز لمجلس الإدارة إضافة أي مستجدات أو بنود جديدة الغاء للبنود او تعديل لجدول أعمال الجمعية العامة الغير عادية قبل موعد انعقادها بعشرة أيام على الأقل، إذا اقتضت مصلحة الشركة أو مساهميها ذلك، على أن يتم إشعار المساهمين بالبنود المضافة وفقًا للإجراءات النظامية المعمول بها.',
            contentAr: 'يجوز لمجلس الإدارة إضافة أي مستجدات أو بنود جديدة الغاء للبنود او تعديل لجدول أعمال الجمعية العامة الغير عادية قبل موعد انعقادها بعشرة أيام على الأقل، إذا اقتضت مصلحة الشركة أو مساهميها ذلك، على أن يتم إشعار المساهمين بالبنود المضافة وفقًا للإجراءات النظامية المعمول بها.'
          },
          {
            title: 'المقترحات والمشاركة',
            titleAr: 'المقترحات والمشاركة',
            content: 'أي مقترحات ترسل على ايميل الشركة قبل موعد الجمعية العمومية الغير عادية',
            contentAr: 'أي مقترحات ترسل على ايميل الشركة قبل موعد الجمعية العمومية الغير عادية'
          },
          {
            title: 'تنويه هام - النصاب',
            titleAr: 'تنويه هام - النصاب',
            content: 'في حال عدم اكتمال النصاب النظامي للاجتماع الأول، سيعقد الاجتماع الثاني بعد ساعة من الموعد المحدد للاجتماع الأول في نفس اليوم والمكان، ويكون الاجتماع الثاني صحيحًا إذا حضره مساهمون يمثلون ربع رأس المال على الأقل، وذلك والنظام الأساسي للشركة.\n\nوفي حال عدم اكتمال النصاب في الاجتماع الثاني، سيتم توجيه دعوة لعقد اجتماع ثالث بنفس اليوم بذات الأوضاع المنصوص عليها، ويكون الاجتماع الثالث صحيحًا أيًا كان عدد الأسهم الممثلة فيه بعد موافقة الجهة المختصة.',
            contentAr: 'في حال عدم اكتمال النصاب النظامي للاجتماع الأول، سيعقد الاجتماع الثاني بعد ساعة من الموعد المحدد للاجتماع الأول في نفس اليوم والمكان، ويكون الاجتماع الثاني صحيحًا إذا حضره مساهمون يمثلون ربع رأس المال على الأقل، وذلك والنظام الأساسي للشركة.\n\nوفي حال عدم اكتمال النصاب في الاجتماع الثاني، سيتم توجيه دعوة لعقد اجتماع ثالث بنفس اليوم بذات الأوضاع المنصوص عليها، ويكون الاجتماع الثالث صحيحًا أيًا كان عدد الأسهم الممثلة فيه بعد موافقة الجهة المختصة.'
          },
          {
            title: 'ملاحظات هامة',
            titleAr: 'ملاحظات هامة',
            content: 'سيتم إتاحة وسائل التقنية الحديثة لتمكين المساهمين من المشاركة والتصويت عن بُعد وفقًا للضوابط المعتمدة من الجهات المختصة.\nلشركات الكبرى الدوليه وللمساهمين قبل موعد الجمعية بنصف ساعه',
            contentAr: 'سيتم إتاحة وسائل التقنية الحديثة لتمكين المساهمين من المشاركة والتصويت عن بُعد وفقًا للضوابط المعتمدة من الجهات المختصة.\nلشركات الكبرى الدوليه وللمساهمين قبل موعد الجمعية بنصف ساعه'
          },
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-6 flex-wrap">
              ...
              {articleId === 'extraordinary-general-assembly-2025' && (
                <div className="flex items-center gap-2">
                  <Badge className="bg-gradient-to-r from-red-600 to-red-800 text-white px-6 py-3 text-lg font-bold animate-pulse border-4 border-red-400 shadow-2xl shadow-red-500/50">
                    🚫 CANCELLED
                  </Badge>
                </div>
              )}
            ...
            <div className="relative">
              ...
              {articleId === 'extraordinary-general-assembly-2025' && (
                <div className="absolute top-0 right-0 z-10">
                  <div className="bg-red-600/20 backdrop-blur rounded-lg p-4 border-4 border-red-500 shadow-2xl shadow-red-500/50 animate-pulse">
                    <div className="text-center text-2xl font-black text-red-400 transform rotate-12">
                      CANCELLED
                    </div>
                    <div className="text-center mt-1 text-sm text-red-300">
              ...
              <h1 className={`text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight pr-28 ${articleId === 'extraordinary-general-assembly-2025' ? 'opacity-60 line-through' : ''}`}>
