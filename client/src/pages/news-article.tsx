...
export default function NewsArticle() {
  ...
  const articleData: Record<string, any> = {
    'general-assembly-success-september-2025': {
      category: 'corporate',
      categoryIcon: Building2,
      title: 'نجاح الجمعية العمومية غير العادية لشركة مكامن بحضور كبار المساهمين',
      titleAr: 'نجاح الجمعية العمومية غير العادية لشركة مكامن بحضور كبار المساهمين',
      date: '2025-09-30',
      author: 'المكتب الإعلامي لشركة مكامن',
      authorAr: 'المكتب الإعلامي لشركة مكامن',
      location: 'الرياض - حي السليمانية',
      locationAr: 'الرياض - حي السليمانية',
      readTime: '5 دقائق قراءة',
      readTimeAr: '5 دقائق قراءة',
      tags: ['حوكمة مؤسسية', 'جمعية عمومية', 'مجلس إدارة', 'مساهمين', 'نجاح'],
      tagsAr: ['حوكمة مؤسسية', 'جمعية عمومية', 'مجلس إدارة', 'مساهمين', 'نجاح'],
      galleryImages: [
        {
      ...
      content: {
        lead: 'عقدت شركة مكامن جمعيتها العمومية غير العادية اليوم بنجاح، بحضور كبار المساهمين، من ضمنهم: شركة الدرة للخدمات البترولية، شركة بيت الطاقة، شركة بن طامي، وشركة عجلان العجلان، إضافة إلى عدد من المساهمين.',
        leadAr: 'عقدت شركة مكامن جمعيتها العمومية غير العادية اليوم بنجاح، بحضور كبار المساهمين، من ضمنهم: شركة الدرة للخدمات البترولية، شركة بيت الطاقة، شركة بن طامي، وشركة عجلان العجلان، إضافة إلى عدد من المساهمين.',
        
        body: [
          {
            title: 'حضور مميز من داخل المملكة وخارجها',
            titleAr: 'حضور مميز من داخل المملكة وخارجها',
            content: 'الجمعية التي انطلقت عند الساعة 12 ظهرًا واستمرت حتى 4:30 عصرًا، شهدت حضورًا مميزًا من داخل المملكة وخارجها، من أبرزهم الدكتور المهندس خالد السيف من دولة الكويت الشقيقة.',
            contentAr: 'الجمعية التي انطلقت عند الساعة 12 ظهرًا واستمرت حتى 4:30 عصرًا، شهدت حضورًا مميزًا من داخل المملكة وخارجها، من أبرزهم الدكتور المهندس خالد السيف من دولة الكويت الشقيقة.'
          },
          {
            title: 'التصويت على البند الأول والتأجيل',
            titleAr: 'التصويت على البند الأول والتأجيل',
            content: 'تم التصويت على البند الأول فقط نظرًا لأهميته القصوى، فيما تقرر تأجيل بقية البنود لمرحلة لاحقة بعد إجراء المواءمة المطلوبة.',
            contentAr: 'تم التصويت على البند الأول فقط نظرًا لأهميته القصوى، فيما تقرر تأجيل بقية البنود لمرحلة لاحقة بعد إجراء المواءمة المطلوبة.'
          },
          {
            title: 'فرز الأصوات والشفافية',
            titleAr: 'فرز الأصوات والشفافية',
            content: 'أُجري فرز الأصوات يدويًا، وجرى منع من لا يملك صلاحية التصويت – رغم حضوره بموجب وكالة – تنفيذًا صارمًا للأنظمة والتعليمات، مما يعكس التزام الشركة بالشفافية وحوكمة الإجراءات.',
            contentAr: 'أُجري فرز الأصوات يدويًا، وجرى منع من لا يملك صلاحية التصويت – رغم حضوره بموجب وكالة – تنفيذًا صارمًا للأنظمة والتعليمات، مما يعكس التزام الشركة بالشفافية وحوكمة الإجراءات.'
          },
          {
            title: 'الاعتذار للغائبين',
            titleAr: 'الاعتذار للغائبين',
            content: 'ونلتمس العذر لمن لم يتمكن من الحضور سواء عبر الرابط الإلكتروني\n\nhttps://teams.live.com/meet/9374841782235?p=9VuZpxCI45KVUjE9La\n\nأو شخصيًا، ونُقدر حرص الجميع على المشاركة في تحقيق أهداف الإصلاح وتطوير الشركة.',
            contentAr: 'ونلتمس العذر لمن لم يتمكن من الحضور سواء عبر الرابط الإلكتروني\n\nhttps://teams.live.com/meet/9374841782235?p=9VuZpxCI45KVUjE9La\n\nأو شخصيًا، ونُقدر حرص الجميع على المشاركة في تحقيق أهداف الإصلاح وتطوير الشركة.'
          },
          {
            title: 'شكر وتقدير',
            titleAr: 'شكر وتقدير',
            content: 'ونشكر أمين السر والسكرتارية والمراقبين على تحملهم الوقت الطويل وصبرهم الذي يشكرون عليه ونشكر خاص لشركة عجلان العجلان وشركة بن طامي والشركات الكبرى والمساهمين والمهندسين والأساتذة الحضور على مقترحاتهم.',
            contentAr: 'ونشكر أمين السر والسكرتارية والمراقبين على تحملهم الوقت الطويل وصبرهم الذي يشكرون عليه ونشكر خاص لشركة عجلان العجلان وشركة بن طامي والشركات الكبرى والمساهمين والمهندسين والأساتذة الحضور على مقترحاتهم.'
          }
        ]
      }
    },
